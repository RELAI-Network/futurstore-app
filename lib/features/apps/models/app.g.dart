...
class _$ApplicationModelDocumentReference extends FirestoreDocumentReference<
  ...
  Future<void> update({
    ...
    final json = {
      ...
      if (type != _sentinel)
        _$ApplicationModelFieldMap['type']!:
            _$ApplicationModelPerFieldToJson.type(type as String),
      if (typeFieldValue != null)
        _$ApplicationModelFieldMap['type']!: typeFieldValue,
...
abstract class ApplicationModelQuery
  ...
  ApplicationModelQuery whereType({
    String? isEqualTo,
    String? isNotEqualTo,
    String? isLessThan,
    String? isLessThanOrEqualTo,
  ...
  ApplicationModelQuery orderByType({
    bool descending = false,
    String startAt,
    String startAfter,
    String endAt,
...
class _$ApplicationModelQuery
  ...
  ApplicationModelQuery whereType({
    ...
    return _$ApplicationModelQuery(
      ...
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        _$ApplicationModelFieldMap['type']!,
        isEqualTo: isEqualTo != _sentinel
            ? _$ApplicationModelPerFieldToJson.type(isEqualTo as String)
            : null,
        isNotEqualTo: isNotEqualTo != _sentinel
            ? _$ApplicationModelPerFieldToJson.type(isNotEqualTo as String)
            : null,
        isLessThan: isLessThan != null
            ? _$ApplicationModelPerFieldToJson.type(isLessThan as String)
            : null,
        isLessThanOrEqualTo: isLessThanOrEqualTo != null
            ? _$ApplicationModelPerFieldToJson
            ...
            : null,
        isGreaterThan: isGreaterThan != null
            ? _$ApplicationModelPerFieldToJson.type(isGreaterThan as String)
            : null,
        isGreaterThanOrEqualTo: isGreaterThanOrEqualTo != null
            ? _$ApplicationModelPerFieldToJson
                .type(isGreaterThanOrEqualTo as String)
            : null,
        whereIn: whereIn?.map((e) => _$ApplicationModelPerFieldToJson.type(e)),
        whereNotIn:
            whereNotIn?.map((e) => _$ApplicationModelPerFieldToJson.type(e)),
        isNull: isNull ??
            (isEqualTo == _sentinel ? false : null) ??
            (isNotEqualTo == _sentinel ? true : null),
      ),
  ...
  ApplicationModelQuery orderByType({
    ...
    final query = $referenceWithoutCursor
        .orderBy(_$ApplicationModelFieldMap['type']!, descending: descending);
    var queryCursor = $queryCursor;
